...
struct  ServicePointManager_t1222  : public Object_t
{
};
struct ServicePointManager_t1222_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t1250 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t1234 * ___server_cert_cb_9;
};
