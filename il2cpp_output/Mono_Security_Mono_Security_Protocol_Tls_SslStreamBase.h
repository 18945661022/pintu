...
struct  SslStreamBase_t1160  : public Stream_t1149
{
	...
	ManualResetEvent_t1148 * ___negotiationComplete_13;
	...
	MemoryStream_t1166 * ___recordStream_15;
};
struct SslStreamBase_t1160_StaticFields{
	// System.Threading.ManualResetEvent Mono.Security.Protocol.Tls.SslStreamBase::record_processing
	ManualResetEvent_t1148 * ___record_processing_2;
};
