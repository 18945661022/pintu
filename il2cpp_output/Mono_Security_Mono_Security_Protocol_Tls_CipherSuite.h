...
struct  CipherSuite_t1123  : public Object_t
{
	...
	SymmetricAlgorithm_t1083 * ___decryptionAlgorithm_17;
	...
	KeyedHashAlgorithm_t1117 * ___clientHMAC_19;
	// System.Security.Cryptography.KeyedHashAlgorithm Mono.Security.Protocol.Tls.CipherSuite::serverHMAC
	KeyedHashAlgorithm_t1117 * ___serverHMAC_20;
};
struct CipherSuite_t1123_StaticFields{
