...
struct  StereoCameraConfiguration_t450  : public MonoCameraConfiguration_t448
{
	// UnityEngine.Camera Vuforia.StereoCameraConfiguration::mSecondaryCamera
	Camera_t53 * ___mSecondaryCamera_17;
