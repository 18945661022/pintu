...
struct  X509Store_t1307  : public Object_t
{
	...
	X509Certificate2Collection_t1301 * ___list_2;
	...
	X509Store_t1104 * ___store_4;
};
struct X509Store_t1307_StaticFields{
	...
	Dictionary_2_t974 * ___U3CU3Ef__switchU24mapF_5;
};
