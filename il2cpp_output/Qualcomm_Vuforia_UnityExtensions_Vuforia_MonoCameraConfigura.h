...
struct  MonoCameraConfiguration_t448  : public Object_t
{
	// UnityEngine.Camera Vuforia.MonoCameraConfiguration::mPrimaryCamera
	Camera_t53 * ___mPrimaryCamera_0;
	...
	Action_t111 * ___mOnVideoBackgroundConfigChanged_3;
	...
	Dictionary_2_t449 * ___mVideoBackgroundBehaviours_4;
	// UnityEngine.Rect Vuforia.MonoCameraConfiguration::mViewportRect
	Rect_t54  ___mViewportRect_5;
