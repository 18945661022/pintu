...
struct  ExtendedKeyUsageExtension_t1109  : public X509Extension_t1103
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t1066 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t1109_StaticFields{
	...
	Dictionary_2_t974 * ___U3CU3Ef__switchU24map14_4;
};
